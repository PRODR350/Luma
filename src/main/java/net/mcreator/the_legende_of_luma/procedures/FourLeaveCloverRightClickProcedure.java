...
public class FourLeaveCloverRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		if ((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getMaterial() == net.minecraft.world.level.material.Material.GRASS
			...
			world.setBlock(new BlockPos((int) x, (int) (y + 1), (int) z), TheLegendeOfLumaModBlocks.FOUR_LEAF_CLOVER_PLANT.defaultBlockState(), 3);
