	...
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
		...
		if ((entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY)
			...
			if ((world.getBlockState(new BlockPos((int) x, (int) (y - 0.23), (int) z))).getBlock() == Blocks.AIR) {
				...
				(new ItemStack(TheLegendeOfLumaModItems.HANG_GLIDER_USED)).setDamageValue((int) ((itemstack).getDamageValue() - 1));
			} else {
				if (entity instanceof LivingEntity _entity)
				...
				(new ItemStack(TheLegendeOfLumaModItems.HANG_GLIDER)).setDamageValue((int) ((itemstack).getDamageValue() - 1));
			}
		} else {
			if (entity instanceof LivingEntity _entity)
				_entity.removeEffect(MobEffects.SLOW_FALLING);
