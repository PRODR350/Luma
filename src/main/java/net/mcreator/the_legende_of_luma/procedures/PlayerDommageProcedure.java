...
public class PlayerDommageProcedure {
	@SubscribeEvent
	...
	private static void execute(@Nullable Event event, LevelAccessor world, Entity entity) {
		...
		if (entity instanceof Player) {
			if (TheLegendeOfLumaModVariables.MapVariables.get(world).IsDomage == false) {
				TheLegendeOfLumaModVariables.MapVariables.get(world).IsDomage = true;
