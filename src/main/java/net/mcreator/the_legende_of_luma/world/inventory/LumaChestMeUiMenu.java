...
public class LumaChestMeUiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public LumaChestMeUiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(TheLegendeOfLumaModMenus.LUMA_CHEST_ME_UI, id);
