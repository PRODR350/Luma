...
public class LumaTowerFeature extends Feature<NoneFeatureConfiguration> {
	public static final LumaTowerFeature FEATURE = (LumaTowerFeature) new LumaTowerFeature().setRegistryName("the_legende_of_luma:luma_tower");
	...
	private final List<Block> base_blocks = List.of(TheLegendeOfLumaModBlocks.LUMAMOSS, Blocks.GRASS_BLOCK);
	private StructureTemplate template = null;

	public LumaTowerFeature() {
