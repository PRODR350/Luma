...
public class LumaDecorLumamossycobblestone1Feature extends Feature<NoneFeatureConfiguration> {
	public static final LumaDecorLumamossycobblestone1Feature FEATURE = (LumaDecorLumamossycobblestone1Feature) new LumaDecorLumamossycobblestone1Feature()
			.setRegistryName("the_legende_of_luma:luma_decor_lumamossycobblestone_1");
	...
	public LumaDecorLumamossycobblestone1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("the_legende_of_luma", "luma_decor_lumemossycobblestone1"));
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 275000) {
