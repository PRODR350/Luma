package net.mcreator.the_legende_of_luma.world.features.treedecorators;
...
public class LumaFruitDecorator extends CocoaDecorator {
	public static final LumaFruitDecorator INSTANCE = new LumaFruitDecorator();
	public static com.mojang.serialization.Codec<LumaFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("luma_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public LumaFruitDecorator() {
		super(0.2f);
	}
