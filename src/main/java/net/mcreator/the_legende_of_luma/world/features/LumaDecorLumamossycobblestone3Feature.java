...
public class LumaDecorLumamossycobblestone3Feature extends Feature<NoneFeatureConfiguration> {
	public static final LumaDecorLumamossycobblestone3Feature FEATURE = (LumaDecorLumamossycobblestone3Feature) new LumaDecorLumamossycobblestone3Feature()
			.setRegistryName("the_legende_of_luma:luma_decor_lumamossycobblestone_3");
	...
	public LumaDecorLumamossycobblestone3Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (template == null)
			template = context.level().getLevel().getStructureManager()
					.getOrCreate(new ResourceLocation("the_legende_of_luma", "luma_decor_lumemossycobblestone3"));
		if (template == null)
			return false;
		if ((context.random().nextInt(1000000) + 1) <= 225000) {
