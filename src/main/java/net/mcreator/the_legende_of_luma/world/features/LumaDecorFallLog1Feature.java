...
public class LumaDecorFallLog1Feature extends Feature<NoneFeatureConfiguration> {
	public static final LumaDecorFallLog1Feature FEATURE = (LumaDecorFallLog1Feature) new LumaDecorFallLog1Feature()
			.setRegistryName("the_legende_of_luma:luma_decor_fall_log_1");
	...
	public LumaDecorFallLog1Feature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("the_legende_of_luma", "luma_decor_log1"));
		if (template == null)
			return false;
