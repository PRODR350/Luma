...
public class LumaDecorLitelMontaineFeature extends Feature<NoneFeatureConfiguration> {
	public static final LumaDecorLitelMontaineFeature FEATURE = (LumaDecorLitelMontaineFeature) new LumaDecorLitelMontaineFeature()
			.setRegistryName("the_legende_of_luma:luma_decor_litel_montaine");
	...
	private final List<Block> base_blocks = List.of(TheLegendeOfLumaModBlocks.LUMASTONE);
	private StructureTemplate template = null;

	public LumaDecorLitelMontaineFeature() {
