...
public class LumaChickenEntity extends Chicken {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		if (SPAWN_BIOMES.contains(event.getName()))
			event.getSpawns().getSpawner(MobCategory.MONSTER)
					.add(new MobSpawnSettings.SpawnerData(TheLegendeOfLumaModEntities.LUMA_CHICKEN, 50, 3, 12));
	}

	public LumaChickenEntity(FMLPlayMessages.SpawnEntity packet, Level world) {
		this(TheLegendeOfLumaModEntities.LUMA_CHICKEN, world);
	}

	public LumaChickenEntity(EntityType<LumaChickenEntity> type, Level world) {
		super(type, world);
		xpReward = 4;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(TheLegendeOfLumaModEntities.LUMA_CHICKEN, SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> (world.getDifficulty() != Difficulty.PEACEFUL
						&& Monster.isDarkEnoughToSpawn(world, pos, random) && Mob.checkMobSpawnRules(entityType, world, reason, pos, random)));
		DungeonHooks.addDungeonMob(TheLegendeOfLumaModEntities.LUMA_CHICKEN, 180);
	}
