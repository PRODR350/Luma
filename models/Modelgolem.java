...
public static class Modelgolem extends EntityModel<Entity> {
	...
	public Modelgolem() {
		...
		body.setTextureOffset(0, 41).addBox(-9.0F, -8.0F, -6.0F, 18.0F, 18.0F, 11.0F, 0.0F, true);
		body.setTextureOffset(0, 70).addBox(-4.5F, 10.0F, -3.0F, 9.0F, 5.0F, 6.0F, 0.5F, true);

		head = new ModelRenderer(this);
		head.setRotationPoint(0.0F, -14.0F, -2.0F);
		head.setTextureOffset(0, 0).addBox(-4.0F, -11.0F, -5.5F, 8.0F, 10.0F, 8.0F, 0.0F, true);
		head.setTextureOffset(24, 0).addBox(-1.0F, -4.0F, -7.5F, 2.0F, 4.0F, 2.0F, 0.0F, true);

		arm0 = new ModelRenderer(this);
		arm0.setRotationPoint(0.0F, -7.0F, 0.0F);
		arm0.setTextureOffset(60, 21).addBox(9.0F, -7.5F, -3.0F, 4.0F, 30.0F, 6.0F, 0.0F, true);

		arm1 = new ModelRenderer(this);
		arm1.setRotationPoint(0.0F, -7.0F, 0.0F);
		arm1.setTextureOffset(60, 58).addBox(-13.0F, -7.5F, -3.0F, 4.0F, 30.0F, 6.0F, 0.0F, true);
